# ====================================================================================
# Setup Project
PROJECT_NAME := provider-bitbucketserver
PROJECT_REPO := github.com/MrVinkel/$(PROJECT_NAME)
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider BitbucketServer CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider BitbucketServer controllers
	@$(GO) run cmd/provider/main.go --debug  --enable-management-policies
...
# This target prepares repo for your provider by replacing all "bitbucketserver"
